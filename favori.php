...
/*
  ...
  $mail=$_SESSION['user_name'];
  //echo $mail;
  $sql = "SELECT id_mes ,id_send,object,message,date_envoi FROM mails WHERE mail_get='$mail' and fav=1 and supp='0'";
  ...
  while( $rows3 = mysqli_fetch_assoc($resultset3) ) { 
    ...
    //    <form action='defavorie.php' method='post'>
    //         <a href='defavorie.php?id=".$id_mess."'>
    //        <button style='border:none;background:none' type='submit' name='supp' value='".$id_mess."'>             
    //        </button>              
    //       </a>                                                  
    //       </form>
